...
var whiteCard = wCards[Math.floor(Math.random()*wCards.length)];
return whiteCard;
}

function whiteCardHand(){
    for (var i = 0; i < 7; i++) {
    var hand = document.getElementById("white-cards");
    hand.innerHTML += '<div class="white-card"><p class="w-card-text">' + randomWhiteCard() + '</div>';
    }
}
whiteCardHand();
